...
def part1():
    ...
    with open('input.txt', 'r') as f_in:
        ...
        for item in pass_list:
            ...
            and  item.count('hcl') == 1 and item.count('ecl') == 1 and item.count('pid') == 1 :
                cnt += 1
...
def part2():
    ...
    with open('input.txt', 'r') as f_in:
        ...
        for item in pass_list:
            ...
            if item.count('byr') == 1 and item.count('iyr') == 1 and item.count('eyr') == 1  and item.count('hgt') == 1 \
            and  item.count('hcl') == 1 and item.count('ecl') == 1 and item.count('pid') == 1  and \
                ( item.count('cid') == 0 or item.count('cid') == 1):
