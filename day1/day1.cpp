...
int main() {
	...
	std::cout << "sum of fuel mass ins task 1 is : " << task_1(std::ifstream{ "input\\day1_input.txt" }) << std::endl;
	std::cout << "sum of fuel mass ins task 2 is : " << task_2(std::ifstream{ "input\\day1_input.txt" }) << std::endl;
